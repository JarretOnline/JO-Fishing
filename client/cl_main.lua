...
local fishAnimation = function()
    ...
    exports['ps-ui']:Circle(function(success)
        if success then
            ...
            exports['okokNotify']:Alert("FISHING", "FAILED!", 2000, 'error')
        end
...
RegisterNetEvent('qb-fishing:client:FishingRod', function()
    ...
    if not canFish then
        exports['okokNotify']:Alert("FISHING", "NOT A FISHING ZONE!", 2000, 'error')
        return
    end
    ...
    if hasItem then
        ...
        exports['okokNotify']:Alert("FISHING", "ROD AND BAIT NEEDED!", 2000, 'error')
    end
end)
